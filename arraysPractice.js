...
function divider(numbersArray) {
	...
	var resultArray = [evenArray, oddArray];
	return resultArray;
}
...
// There is also a commented out array full of numbers to help you visualize what your function will
// be receiving.
...
sure that it's equal to 4. */
  ...
  //Code Here
var devMountainEmployees = function(arr, obj) {
	arr.push(obj);
};
...
var leaveOfAbsence = function(arr, obj) {
	for (var i = 0; i < arr.length; i++) {
		if (array[i] === obj) {
			array.splice(arr.indexOf(obj), 1);
		}
	}
	return array;
};
